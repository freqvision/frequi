...
import { formatObjectForTable } from '@frequi/shared/objectToTableItems';

import { computed } from 'vue';
import { generateBacktestMetricRows } from '@frequi/shared/backtestMetrics';
import { TableField } from 'bootstrap-vue-next';
import BacktestResultSelectEntry from '@frequi/components/ftbot/BacktestResultSelectEntry.vue';
